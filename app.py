...
def generate_frames_yoga():
 with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
    ...
    while True:
        ...
        frame, landmarks = detectPose(frame, pose_video, display=False)  # Assuming you have a detectPose function

        # Check if the landmarks are detected.
        if landmarks:
            # Perform the Pose Classification.
            frame, _ = classifyPose(landmarks, frame, display=False)  # Assuming you have a classifyPose function
...
@app.route('/')
def index():
    details_url = "/details"  # Replace with the actual URL
